                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="action/delete-rdp.php?id_rdp=<?php echo $data['id_rdp']; ?>" class="btn btn-secondary rounded-pill" onclick=" confirm('Hapus data ini?')"><i class="bi bi-trash-fill"></i></a>
                      </td>
                    </tr>
                  <?php } ?>
                </tbody>
