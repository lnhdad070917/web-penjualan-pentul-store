        ...
        <div class="col-lg-6">
          ...
          <div class="card">
            <div class="card-body">
              ...
              include 'koneksi.php';
              $id_rdp = $_GET['id_rdp'];
              $data = mysqli_query($koneksi, "SELECT*FROM rdp WHERE id_rdp='$id_rdp'");
              while ($hasil = mysqli_fetch_array($data)) {
              ?>
              <!-- General Form Elements -->
              <form action="action/edit-rdp.php">
                <div class="row mb-3">
                  <label for="cpanel" class="col-sm-2 col-form-label">ID_RDP </label>
                  <div class="col-sm-10">
                    <input type="text" name="id_rdp" class="form-control" readonly value= "<?php echo $hasil['id_rdp']; ?>">
                  </div>
                </div>
                <div class="row mb-3">
