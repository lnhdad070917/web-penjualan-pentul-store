        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                ...
                <ul id="forms-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                    ...
                    <li>
                        <a href="forms-vps.php" class="active">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            include 'koneksi.php';
                            $id_vps = $_GET['id_vps'];
                            $data = mysqli_query($koneksi, "SELECT*FROM vps WHERE id_vps='$id_vps'");
                            while ($hasil = mysqli_fetch_array($data)) {
                            ?>
                                <!-- General Form Elements -->
                                <form action="action/edit-vps.php">
                                    <div class="row mb-3">
                                        <label for="cpanel" class="col-sm-2 col-form-label">ID_VPS </label>
                                        <div class="col-sm-10">
                                            <input type="text" name="id_vps" class="form-control" readonly value="<?php echo $hasil['id_vps']; ?>">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label for="cpanel" class="col-sm-2 col-form-label">Panel ke - </label>
                                        <div class="col-sm-10">
                                            <input type="text" name="panel" class="form-control" value="<?php echo $hasil['panel']; ?>">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label for="cip" class="col-sm-2 col-form-label">IP RDP</label>
                                        <div class="col-sm-10">
                                            <input type="text" name="ip" class="form-control" value="<?php echo $hasil['ip']; ?>">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-select" name="core" aria-label="Default select example">
                                                <option selected> <?php echo $hasil['core']; ?></option>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-select" name="ram" aria-label="Default select example">
                                                <option selected><?php echo $hasil['ram']; ?></option>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="note" class="form-control" value="<?php echo $hasil['note']; ?>">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label for="cdate" class="col-sm-2 col-form-label">Date</label>
                                        <div class="col-sm-10">
                                            <input type="date" name="date" class="form-control" value="<?php echo $hasil['tgl_buat']; ?>">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
