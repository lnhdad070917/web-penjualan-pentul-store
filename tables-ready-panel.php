            ...
            <div class="card-body">
              ...
              <table class="table datatable">
                ...
                <tbody>
                  <?php
                  include 'koneksi.php';
                  $query = mysqli_query($koneksi, "SELECT * from panel Where status LIKE 'r%'");
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="action/sold-panel.php?id_panel=<?php echo $data['id_panel']; ?>" class="btn btn-danger rounded-pill">Jual</a>
