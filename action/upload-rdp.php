<?php
    header("location:../tables-ready-rdp.php?pesan=success");
?>
<?php
include "../koneksi.php";
...
$query = mysqli_query($koneksi, "INSERT INTO `rdp` (`id_rdp`, `ip`, `tgl_buat`, `core`, `ram`, `panel`, `status`, `username`, `pass`, `note`) 
