          ...
          <div class="card">
            <div class="card-body">
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        <a href="forms-rdp-edit.php?id_rdp=<?php echo $data['id_rdp']; ?>" class="btn btn-warning rounded-pill"><i class="bi bi-pencil-square"></i></a>
                        <a href="action/sold-rdp.php?id_rdp=<?php echo $data['id_rdp']; ?>" class="btn btn-danger rounded-pill"><i class="bi bi-cash-coin"></i></a>
                        <a href="action/delete-rdp.php?id_rdp=<?php echo $data['id_rdp']; ?>" class="btn btn-secondary rounded-pill" onclick="return confirm('Hapus data ini?')"><i class="bi bi-trash-fill"></i></a>
                        <a href="kirim-rdp.php?id_rdp=<?php echo $data['id_rdp']; ?>" class="btn btn-info rounded-pill"><i class="bi bi-textarea-t"></i></a>
                      </td>
                    </tr>
                  <?php } ?>
                </tbody>
              ...
              <div class="container-fluid">
                <form action="laporan/laporan_rdp.php">
                  <div class="row mb-3">
                    <div class="col-sm-2">
