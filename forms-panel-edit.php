        ...
        <div class="col-lg-6">
          ...
          <div class="card">
            <div class="card-body">
              ...
              $data = mysqli_query($koneksi, "SELECT*FROM panel WHERE id_panel='$id_panel'");
              while ($hasil = mysqli_fetch_array($data)) {
              ?>
                <!-- General Form Elements -->
                <form action="action/edit-panel.php">
                  <div class="row mb-3">
                    <label for="cid_panel" class="col-sm-2 col-form-label">id_panel</label>
                    <div class="col-sm-10">
                      <input type="text" id="cid_panel" name="id_panel" class="form-control" readonly value="<?php echo $hasil['id_panel']; ?>">
                    </div>
                  </div>
                  <div class="row mb-3">
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                      <input type="date" id="cdate" name="date" class="form-control" value="<?php echo $hasil['tgl_buat']; ?>">
                    </div>
                  </div>
                  <div class="row mb-3">
