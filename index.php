  ...
  <main id="main" class="main">
    ...
    <section class="section dashboard">
        ...
        <div class="container-fluid">
          <div class="row">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <?php
                      include 'koneksi.php';
                      $data_panel = mysqli_query($koneksi, "SELECT * FROM vps Where status LIKE 'r%'");
                      $jumlah_panel = mysqli_num_rows($data_panel);
                      ?>
                      <h6><?php echo $jumlah_panel; ?> VPS</h6>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <?php
                      include 'koneksi.php';
                      $data_panels = mysqli_query($koneksi, "SELECT * FROM vps Where status LIKE 's%'");
                      $jumlah_panels = mysqli_num_rows($data_panels);
                      ?>
                      <h6><?php echo $jumlah_panels; ?> VPS</h6>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <?php
                      include 'koneksi.php';
                      $data_panel = mysqli_query($koneksi, "SELECT * FROM panel Where status LIKE 'r%'");
                      $jumlah_panel = mysqli_num_rows($data_panel);
                      ?>
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <?php
                      include 'koneksi.php';
                      $data_panels = mysqli_query($koneksi, "SELECT * FROM panel Where status LIKE 's%'");
                      $jumlah_panels = mysqli_num_rows($data_panels);
                      ?>
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <?php
                      include 'koneksi.php';
                      $data_panels = mysqli_query($koneksi, "SELECT * FROM login Where level LIKE 'u%'");
                      $jumlah_panels = mysqli_num_rows($data_panels);
                      ?>
                      <h6><?php echo $jumlah_panels; ?> User</h6>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <?php
                      include 'koneksi.php';
                      $data_panels = mysqli_query($koneksi, "SELECT * FROM login Where level LIKE 'a%'");
                      $jumlah_panels = mysqli_num_rows($data_panels);
                      ?>
                      <h6><?php echo $jumlah_panels; ?> Admin</h6>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card revenue-card">
                <div class="card-body">
                  <h5 class="card-title">Pemesanan <span>|Belum diproses</span></h5>
                  <div class="d-flex align-items-center">
                    <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                    ...
                    <div class="ps-3">
                      <?php
                      include 'koneksi.php';
                      $data_panels = mysqli_query($koneksi, "SELECT * FROM pemesanan Where status LIKE 'p%'");
                      $jumlah_panels = mysqli_num_rows($data_panels);
                      ?>
                      <h6><?php echo $jumlah_panels; ?> Pesanan</h6>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div class="col">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title">LAPORAN <span>| Pemesanan</span></h5>
            <table class="table table-borderless datatable">
              ...
              <tbody>
                <?php
                include 'koneksi.php';
                $query = mysqli_query($koneksi, "SELECT * from pemesanan WHERE status = 'proses' ");
                ...
                ?>
                  <tr>
                    ...
                    <td>
                      <a href="action/terima.php?id_pemesanan=<?php echo $data['id_pemesanan']; ?>" onclick="return confirm('Apakah anda yaqin ?')" class="btn btn-warning rounded-pill"><i class="ri-money-dollar-circle-line"></i>&ensp;Terima</a>
                      <a href="action/tolak.php?id_pemesanan=<?php echo $data['id_pemesanan']; ?>" class="btn btn-warning rounded-pill"><i class="ri-money-dollar-circle-line"></i>&ensp;Tolak</a>
                      <a href="detail_beli.php?id_pemesanan=<?php echo $data['id_pemesanan']; ?>" class="btn btn-warning rounded-pill"><i class="ri-money-dollar-circle-line"></i>&ensp;Detail</a>
                    </td>
                  </tr>
                <?php } ?>
              </tbody>
      ...
      <div class="col">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title">LAPORAN <span>| Terjual</span></h5>
            <table class="table table-borderless datatable">
              <thead>
                <tr>
                  <th scope="col">Tanggal Bayar</th>
              ...
              <tbody>
                <?php
                include 'koneksi.php';
                $query = mysqli_query($koneksi, "SELECT * from pemesanan WHERE status = 'diterima' ");
                while ($data = mysqli_fetch_array($query)) {
                ?>
                  <tr>
                    <td><?php echo $data['tgl_bayar']; ?></td>
            ...
            <div class="container-fluid">
              <form action="laporan/laporan_pesanan_admin.php">
                <div class="row mb-3">
                  <div class="col-sm-2">
